        ...
        try {
            if(o.getClass().equals(BasicDBObject.class))
            {
                try {
                    ...
                    System.err.println("Adding new todo [category=" + category + ", status=" + status + " owner=" + owner + " body=" + body + ']');
                    return todoController.addNewTodo(category, status, owner, body).toString();
                }
